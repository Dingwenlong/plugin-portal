...
def build_parser() -> argparse.ArgumentParser:
    ...
    access.add_argument("--read-only", action="store_true", help="局域网只读模式，禁止管理和编辑")
    access.add_argument("--remote-management", action="store_true", help="HTTPS 代理后的远端管理模式")
    serve.add_argument("--https-origin", help="HTTPS 代理的明确公开来源；代理后台必须绑定本机 9135")
